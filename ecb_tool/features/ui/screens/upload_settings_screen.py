"""Pantalla de configuración de uploads."""
...
from ecb_tool.features.ui.blocks.upload_settings_dialog import UploadSettingsDialog


class UploadSettingsScreen(QWidget):
    """Pantalla de configuración de uploads."""
    ...
    def _init_ui(self):
        ...
        title = QLabel(self.language_manager.get_text('upload_settings'))
        ...
        self.settings_dialog = UploadSettingsDialog(None)
    ...
    def _save_settings(self):
        """Guarda la configuración de uploads."""
